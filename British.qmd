...
```{r}
#|label: British plot
ggplot(British, aes(x = fct_reorder(Driver, Time_Retired), y = Time_Retired, fill = Driver)) +
  geom_bar(stat = "identity") +
  labs(title = "British GP 2023",
...
```
[Data](https://www.motorsport.com/f1/results/2023/british-gp-625312/)
